...
<div class="wrap-body">
    ...
    <nav class="cmn-tile-nav">
		<ul class="clearfix">
			...
			<li class="colour-2"><a href="menu.jsp">菜单</a></li>
			<li class="colour-4"><a href="archive.jsp">动态</a></li>
			<li class="colour-5"><a href="staff.jsp">员工</a></li>
			<li class="colour-7"><a href="reservation.jsp">预订</a></li>
			<li class="colour-8"><a href="gallery.jsp">画廊</a></li>
		</ul>
    </nav>
		...
		<section class="content-box box-1">
			<div class="zerogrid">
				<div class="row box-item"><!--Start Box-->
					<h2>Ã¢ÂÂYour awesome company slogan goes here, we have the best food aroundÃ¢ÂÂ</h2>
		...
		<div class="row">
			...
			<div class="col-1-3">
				<div class="wrap-col">
					...
					<p><span>tue.-wed.</span> 16:30 Ã¢ÂÂ 21:00</p>
					<p><span>thu.-sat.</span> 16:30 Ã¢ÂÂ 21:00</p>
					<p><span>sun.</span> 11:00 Ã¢ÂÂ 21:00</p>
