	...
	<form action="UserAddServlet" method="post"
		...
		<table class="table table-bordered table-hover definewidth m10">
			<tr>
				...
				<td><select name="utype" style="width: 206px">
			...
			<tr class="utype1">
				<td class="tableleft">设置密码</td>
				<td><input type="password" name="upassword" id="psw1" /></td>
			</tr>
			<tr class="utype1">
				<td class="tableleft">重复密码</td>
				<td><input type="password" id="psw2" /><span id="psw_msg"></span></td>
			</tr>
			<tr>
				<td class="tableleft">联系电话</td>
				<td><input type="text" name="utelphone" /></td>
			</tr>
			<tr class="utype2">
				<td class="tableleft">员工介绍</td>
				<td><textarea name="ustaffinfo" rows=5 /></textarea></td>
			</tr>
			<tr class="utype2">
				<td class="tableleft">主页显示</td>
				<td><input type="radio" name="ustaffdisplay" value="0" checked="checked"><span>不显示</span>
					<input type="radio" name="ustaffdisplay" value="1"><span>显示</span>
				</td>
			</tr>
			<tr class="utype2">
				...
				<td><img width="206" src="" id="pic_show"> <span><a
					...
					type="hidden" name="upic" value="" /></td>
			</tr>
			<tr>
				<td class="tableleft"></td>
				<td>
					<button type="submit" class="btn btn-primary" type="button">新增用户</button>&nbsp;&nbsp;
